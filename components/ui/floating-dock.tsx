  ...
  return (
    ...
    >
      <motion.div
        ...
        className={cn(
          "absolute bottom-4 items-center transform -translate-x-1/2 flex justify-center h-14 p-2 gap-3  bg-opacity-90 rounded-xl",
...
function DockCard({ children, id }: DockCardProps) {
  ...
  const distance = useTransform(dock.mouseX, (val: any) => {
