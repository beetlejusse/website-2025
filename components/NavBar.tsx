...
const Navbar = () => {
  return (
    <motion.div
      ...
      className="fixed top-4 left-1/2 -translate-x-1/2 w-[70%] sm:w-[50%] md:w-[40%] bg-[#0a0f1d]/80 backdrop-blur-lg text-white rounded-xl shadow-lg flex items-center justify-center px-6 py-3 z-50"
    >
      <div className="flex items-center font-bold text-xl sm:text-2xl md:text-3xl font-oswald">
        <span className="mr-2">IEEE</span>
        <RotatingText
          texts={["BPIT"]}
