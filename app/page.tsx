...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col justify-center items-center text-white" style={{
    ...
    >
      ...
      <motion.button
        ...
        className="absolute top-6 left-6 px-5 py-2 rounded-lg bg-white/10 backdrop-blur-lg text-white font-semibold shadow-md hover:bg-white/20 transition-all cursor-pointer"
        onClick={() => {
          handleGalleryClick;
        }}
      >
      ...
      <motion.button
        ...
        animate={{ x: 0, opacity: 1 }}
        transition={{ duration: 0.8, ease: "easeOut" }}
        className="absolute top-6 right-6 px-5 py-2 rounded-lg bg-white/10 backdrop-blur-lg text-white font-semibold shadow-md hover:bg-white/20 transition-all cursor-pointer"
        onClick={() => {
          handleSIGclick;
        }}
      >
